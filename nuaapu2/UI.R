...
shinyUI(pageWithSidebar(
  ...
  sidebarPanel(
    ...
    numericInput("r", label = h3("ROPElow"), value = -1),
    
    numericInput("s", label = h3("ROPEHigh"), value = 1)
  ),
  mainPanel(
    tabsetPanel(
      tabPanel("About",  
      ...
      tabPanel("Data checking",
               ...
               tabPanel("Parametric inference",
                        ...
                        p("Thus we successfully performed Bayesian t test with help of shiny basedimplementation of Bayesian tests/functions from John Kruschke and Richard Morey "),
