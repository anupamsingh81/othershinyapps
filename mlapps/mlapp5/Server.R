...
shinyServer(function(input, output) {
  ...
  Aa = multiplot(Ap , Bp, Cp, Dp,Ep,Fp,Gp,Hp, cols=2)
  
  # crosstabs and t test
  ...
  Ab = list(pc,qc,rc,sc,Age.t,RBS.t,GCS.t,MAP.t) 
  ...
  e8 = print ( " ICH score based on input and Predictions made by it  " )
   ...
   p = list(modelLR,modelNB,modelRF,e9,e1,temps$LR,e7,temps$RF,e8,k,newich) 
